            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: ColorSchemeApp.goldenAccent.withValues(alpha: 0.2),
                          borderRadius: BorderRadius.circular(20),
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            const Icon(Icons.star, color: ColorSchemeApp.goldenAccent, size: 20),
                  ...
                  Row(
                    children: [
                      const Icon(Icons.phone, color: ColorSchemeApp.primaryGreen),
                      const SizedBox(width: 8),
                      Text(
                        hosteria.telefono,
                        style: theme.textTheme.bodyMedium,
                  ...
                  Wrap(
                    ...
                    children: hosteria.servicios.map((servicio) {
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          color: ColorSchemeApp.sandBeige.withValues(alpha: 0.5),
                          borderRadius: BorderRadius.circular(20),
                        ),
                        child: Text(
                          servicio,
