  ...
  static ThemeData get theme {
    return ThemeData(
      ...
      colorScheme: ColorScheme.fromSeed(
        ...
        secondary: ColorSchemeApp.warmBrown,
        tertiary: ColorSchemeApp.goldenAccent,
        surface: ColorSchemeApp.offWhite,
        error: ColorSchemeApp.error,
      ),
      scaffoldBackgroundColor: ColorSchemeApp.offWhite,
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(14),
          borderSide:
              const BorderSide(color: ColorSchemeApp.primaryGreen, width: 2),
        ),
        ...
        focusedErrorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(14),
          borderSide:
              const BorderSide(color: ColorSchemeApp.error, width: 2),
        ),
