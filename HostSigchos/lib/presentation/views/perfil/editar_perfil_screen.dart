...
class _EditarPerfilScreenState extends State<EditarPerfilScreen> {
  ...
  void initState() {
    ...
    _telefonoController = TextEditingController(text: phoneText.replaceFirst(_selectedPhonePrefix, ''));
    ...
    if (locText.isNotEmpty) {
      ...
      if (parts.length >= 2) {
        ...
        _customCityController.text = parts.sublist(0, parts.length - 1).join(', ');
      } else {
